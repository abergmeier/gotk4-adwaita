...
//
// * <kbd>Ctrl</kbd>+<kbd>Page Up</kbd> - switch to the previous
// page * <kbd>Ctrl</kbd>+<kbd>Page Down</kbd> - switch to the next
// page * <kbd>Ctrl</kbd>+<kbd>Home</kbd> - switch to the first
// page * <kbd>Ctrl</kbd>+<kbd>End</kbd> - switch to the last page
// * <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Page Up</kbd> - move the
// current page backward * <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Page
// Down</kbd> - move the current page forward *
// <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Home</kbd> - move the current page
// at the start * <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>End</kbd> - move the
// current page at the end * <kbd>Ctrl</kbd>+<kbd>Tab</kbd> - switch to the next
// page, with looping * <kbd>Ctrl</kbd>+<kbd>Shift</kbd>+<kbd>Tab</kbd> - switch
// to the previous page, with looping * <kbd>Alt</kbd>+<kbd>1</kbd>⋯<kbd>9</kbd>
